...
export default function Welcome({ demos }: WelcomeProps) {
    return (
        <>
            <Head title="Laragentic Examples">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 text-2xl font-medium">Laragentic Examples</h1>
                            <p className="mb-6 text-[#706f6c] dark:text-[#A1A09A]">
                                Working examples of agentic AI loops built on the Laravel AI SDK.
                                <br />
                            ...
                            <ul className="mb-6 flex flex-col gap-4">
                                {demos.map((demo, index) => (
                                    <li key={index} className="group">
                                        <Link
                                            href={demo.url}
                                            className="block rounded-lg border border-[#e3e3e0] bg-[#FDFDFC] p-4 shadow-sm transition-all hover:border-[#f53003] hover:shadow-md dark:border-[#3E3E3A] dark:bg-[#161615] dark:hover:border-[#FF4433]"
                                        >
                                            <h2 className="mb-1 font-medium text-[#1b1b18] group-hover:text-[#f53003] dark:text-[#EDEDEC] dark:group-hover:text-[#FF4433]">
                                                {demo.title}
                                            </h2>
                                            <p className="text-[#706f6c] dark:text-[#A1A09A]">{demo.description}</p>
                                        </Link>
                                    </li>
                                ))}
                            </ul>
                            <div className="flex gap-3 text-sm">
                                <a
                                    href="https://github.com/laragentic/laragentic"
                                    target="_blank"
                                ...
                                <a
                                    href="https://laravel.com/docs/12.x/ai-sdk"
                                    target="_blank"
                                    className="inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
